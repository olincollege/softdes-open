...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            intake_survey.previous_programming_experience,
            id="programming_experience",
        ),
        pytest.param(
            intake_survey.previous_python_experience, id="python_experience"
        ),
        pytest.param(
            intake_survey.previous_tools_experience, id="tools_experience"
        ),
    ],
)
